...
<p style="font-family:Yekan;padding-right:30px;padding-top:20px;padding-bottom:10px;">نمایش مسابقات تایید <span style="color:red;">نشده</span></p>
...
$GridView=GridView2::view($array1,$array2,$model,$page=1,$total=10,$ntable='mosabeghe');
