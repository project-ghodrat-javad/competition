 ...
 <div style="width:95%;height:3px;background:#48adff;margin:auto;margin-bottom:30px;"></div>
    ...
    <?php
        if($errors->has('title'))
        {
            ...
            {!! Form::text('title',null,['class'=>'form-control','id'=>'inputError','placeholder'=>'عنوان مسابقه','style'=>'width:600px;','readonly'=>true]) !!}
    ...
    {?>
        <div class="form-group">
            ...
            {!! Form::text('title',null,['class'=>'form-control','placeholder'=>'عنوان مسابقه','style'=>'width:600px;','readonly'=>true]) !!}
        </div>
    <?php } ?>
        ...
        <?php
            if($errors->has('question'))
            {
                ...
                {!! Form::text('question',null,['class'=>'form-control','id'=>'inputError','placeholder'=>'پرسش خود را درج نمایید','style'=>'width:600px;','readonly'=>true]) !!}
        ...
        {?>
            <div class="form-group">
                ...
                {!! Form::text('question',null,['class'=>'form-control','placeholder'=>'پرسش خود را درج نمایید.','style'=>'width:600px;','readonly'=>true]) !!}
            </div>
        <?php } ?>
        ...
        <div>
            ...
            {!! Form::textarea('details',null,['class'=>'ckeditor','readonly'=>true]) !!}
        </div>
        ...
        <div>
            ...
            {!! Form::textarea('rules',null,['class'=>'ckeditor','readonly'=>true]) !!}
        </div>
        ...
        <div>
            <div class="form-input" style="margin-top:20px;">
                ...
                {!! Form::file('img_logo1',['style'=>'direction:ltr;width:250px;','readonly'=>true]) !!}
            </div>
        ...
        <div>
            <div class="form-input" style="margin-top:30px;">
                ...
                {!! Form::file('img1',['style'=>'direction:ltr;width:250px;','readonly'=>true]) !!}
            </div>
            <div style="float:left;margin-left:250px;">
    ...
    <div style="margin-top:50px;" id="box2">
        ...
        ?>
            ...
            {{ Form::checkbox('know2',null,true,['class'=>'checkclick','readonly'=>true]) }}
        <?php
            }else{ 
        ?>
            {{ Form::label('know2','بدون جایزه / علمی') }}
            {{ Form::checkbox('know2',null,false,['class'=>'checkclick','readonly'=>true]) }}
        <?php } ?>
        ...
        if($errors->has('first'))
        {
            ...
            {!! Form::text('first',null,['class'=>'form-control','id'=>'inputError','placeholder="جایزه نفر اول را وارد نمایید."','style'=>'width:600px;','readonly'=>true]) !!}
    ...
    {?>
        <div class="form-group">
            ...
            {!! Form::text('first',null,['class'=>'form-control','placeholder="جایزه نفر اول را وارد نمایید."','style'=>'width:600px;','readonly'=>true]) !!}
        </div>
    <?php } ?>
    ...
    <?php
        if($errors->has('two'))
        {
            ...
            {!! Form::text('two',null,['class'=>'form-control','id'=>'inputError','placeholder="جایزه نفر دوم را وارد نمایید."','style'=>'width:600px;','readonly'=>true]) !!}
    ...
    {?>
        <div class="form-group">
            ...
            {!! Form::text('two',null,['class'=>'form-control','placeholder="جایزه نفر دوم را وارد نمایید."','style'=>'width:600px;','readonly'=>true]) !!}
        </div>
    <?php } ?>
    ...
    <?php
        if($errors->has('three'))
        {
            ...
            {!! Form::text('three',null,['class'=>'form-control','id'=>'inputError','placeholder="جایزه نفر سوم را وارد نمایید."','style'=>'width:600px;','readonly'=>true]) !!}
    ...
    {?>
        <div class="form-group">
            ...
            {!! Form::text('three',null,['class'=>'form-control','placeholder="جایزه نفر سوم را وارد نمایید."','style'=>'width:600px;','readonly'=>true]) !!}
        </div>
    <?php } ?>
        ...
        <div>
            ...
            {!! Form::open(['url'=>'admin/add/file','files'=>true]) !!}
                <div class="form-input" style="margin-top:50px;">
                    ...
                    {!! Form::file('f',['style'=>'direction:ltr;width:250px;','readonly'=>true]) !!}
                </div>

                <div class="form-group">
                    {!! Form::label('fil','عنوانی برای فایل وارد نمایید.',['class'=>'control-label','for'=>'inputError']) !!}
                    {!! Form::text('fil',null,['class'=>'form-control','id'=>'inputError','placeholder="عنوانی برای فایل وارد نمایید."','style'=>'width:600px;','readonly'=>true]) !!}
                </div> 
                </div>                
            {{ Form::close() }}
            ...
            <div style="margin-top:50px;">
                ...
                <div style="margin-top:30px;" id="box3-1">
                    <?php
                    use App\lib\Show;
                    $array1=array('ردیف','عنوان ','لینک ');
                    $array2=array('-','title','file');
                    $GridView=Show::view($array1,$array2,$model3,$page=1,$total=2,$ntable='delete/file');
                    ?>
                </div>
    ...
    <div style="margin-bottom:50px;margin-top:50px;" id="box4">
        ...
        {!! Form::open(['url'=>'users/panel/script','files'=>true]) !!}
        ...
        <div style="margin-top:50px;">
            {{ Form::label('know4','اسکریپت های ثبت شده شما برای این مسابقه') }}
            {{ Form::checkbox('know4',null,false,['class'=>'checkclick','onClick'=>'getcheck2()']) }}

            <p style="font-family:Yekan;padding-right:30px;padding-top:20px;padding-bottom:10px;">
                نمایش اسکریپت های ثبت شده شما برای این مسابقه
            </p>
            <div style="width:95%;height:3px;background:#48adff;margin:auto;margin-bottom:30px"></div>
            ...
            <div style="margin-top:30px;" id="box4-1">
                ...
                $GridView=GridView3::view($array1,$array2,$model4,$page=1,$total=2,$ntable='panel/script');
                ?>
            </div>
