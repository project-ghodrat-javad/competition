...
<head>
    ...
    <title>Competitions | Kaggle</title>
    ...
    <meta charset="utf-8">
    <link rel="stylesheet" href="resources/css/base.less" type="text/css">
    <link rel="stylesheet" href="resources/css/kaggle-site.less" type="text/css">
    <link rel="stylesheet" href="resources/css/style.css" id="intercom-styles" type="text/css">
    <script src="https://widget.intercom.io/widget/koj6gxx6" async="" type="text/javascript"></script><script src="resources/js/ga.js" async="" type="text/javascript"></script><script src="https://widget.intercom.io/widget/koj6gxx6" async="" type="text/javascript"></script><script src="resources/js/ga.js" async="" type="text/javascript"></script><script src="https://widget.intercom.io/widget/koj6gxx6" async="" type="text/javascript">
    </script><script src="resources/js/ga.js" async="" type="text/javascript">
    </script><script type="text/javascript" src="resources/js/jquery-1.7.2.min.js"></script>
    <script type="text/javascript" src="resources/js/jquery-ui-1.9.2.min.js"></script>
    <script type="text/javascript" src="resources/js/kaggle.min.js"></script>
...
<div id="wrap"><!-- 3   needed for sticky footer -->
    <div id="menu-open-overlay"></div>
    <div id="header2" class="">
        <div id="header2-inside" class="">
            <ul id="header-control">
                <!--<li id="header-account"><a class="profilelink" href="/ghodrat" title="View my profile">GhodratHeydari</a></li>-->
                <li id="header-logout"><a href="/account/logoff" class="logout-link">خروج</a></li>
            ...
            <a id="logo" href="/"><img alt="Kaggle" src="resources/images/site-logo.png" height="86" width="240"></a>
    ...
    <div class= 'container' style="margin-top:20px;margin-bottom:230px">
        ...
        <div id="logobig" style="width:85%;float:right"><img src="resources/images/bigdata.png"></div>
        <!--<div id="competitions-intro" style="">
            <div>
          <h1>Welcome to Kaggle's data science competitions.</h1>
          <p>
            New to Data Science?<br> <a href="/c/titanic">Tutorials on the Titanic competition ?</a><br><br>
            Want to learn from other's code?<br> <a href="/scripts">Kaggler's top rated scripts ?</a><br>
          </p>
          </div>

          <ul>
            <li>
              <img src="img/competitions-intro-step1.png" alt="Enter">
              <h2>Download</h2>
              <p>Choose a competition &amp; download the training data.
              </p>
            </li>
            <li>
              <img src="img/competitions-intro-step2.png" alt="Build">
              <h2>Build</h2>
              <p>Build a model using whatever methods and tools you prefer.
              </p>
            </li>
            <li>
              <img src="img/competitions-intro-step3.png" alt="Win">
              <h2>Submit</h2>
              <p> Upload your predictions. Kaggle scores your solution and shows your score on the leaderboard.
              </p>
            </li>
          </ul>
        </div> -->
            ...
            <div id="sidebar-all-competitions" style="display: none;">
                <form id="competitions-sidebar" action="/competitions/search" method="GET">
                    <h2 id="competitions-found"><span id="sidebar-total-comps-found">13</span> مورد یافت شد,
                        <span id="sidebar-active-comps-found">13</span> فعال <img src="resources/images/spinner-small.gif" alt="Wait cursor" class="spinner" style="display:none;">
                    </h2>
                    <input id="search" name="Query" placeholder="Search competitions" type="text">
        ...
        <div id="competitions-content">
                ...
                <li class="home-item current-comps _panel">
                    ...
                    <div class="front-current-container" id="recruitment-container">
                        <ul class="front-current multiple" id="recruitment">
                            <li>
                                <img class="front-current-image" src="resources/images/thumb76_76.png" alt="Facebook V: Predicting Check Ins" title="Facebook V: Predicting Check Ins" height="76" width="76">
                                <div class="front-comp-details">
                                    <div class="comp-desc-column">
                                        <h3>
                                            <a class="comp-link" href="/c/facebook-v-predicting-check-ins">Facebook V: Predicting Check Ins</a>
                                        </h3>
                                        <div class="job-desc">
                                            <div class="job-title">
            ...
            <div id="competitions-all" style="display: none;">
                <table id="competitions-table">
                    ...
                    <tr>
                        <th class="not-sorted">
                            <a href="/competitions/search?CompetitionNameColumnSort=Ascending" title="Sort by Competition Name"><img alt="Sort" src="resources/images/sort-not-sorted.png"> نام مسابقه </a>
                        </th>
                        <th class="sorted descending">
                            <a href="/competitions/search?RewardColumnSort=Ascending" title="Current sorting by Reward descending. Click to reverse."><img alt="Sort" src="resources/images/sort-descending.png"> جایزه &nbsp;<!-- extra space to center text --></a>
                        ...
                        <th class="not-sorted">
                            <a href="/competitions/search?TeamsColumnSort=Descending" title="Sort by Teams"><img alt="Sort" src="resources/images/sort-not-sorted.png"> تیم ها &nbsp;<!-- extra space to center text --></a>
                        </th>
                        <th class="not-sorted">
                            <a href="/competitions/search?DeadlineColumnSort=Descending" title="Sort by Deadline"><img alt="Sort" src="resources/images/sort-not-sorted.png"> آخرین فرصت &nbsp;<!-- extra space to center text --></a>
                        </th>
                    </tr></thead>
                    ...
                    <tr class="active-comp">
                        <td>
                            <a href="/c/state-farm-distracted-driver-detection"><img class="competition-image" src="resources/images/thumb76_76.png" alt="state-farm-distracted-driver-detection Image" height="76" width="76"></a>
                            <div class="competition-details">
                                <div class="competitions-types"></div>
                                <a href="/c/state-farm-distracted-driver-detection"><h4>State Farm Distracted Driver Detection</h4></a>
                                <p class="competition-summary">
                                    <a href="/c/state-farm-distracted-driver-detection">Can computer vision spot distracted drivers?</a>
                                </p>
                            </div>
                        </td>
                        <td>$65,000</td>
...
</div><!--end  3   needed for sticky footer -->							 <!-- wrap -->
